\chapter{Algebraic Integers}
	...
	\section{Galois extensions}
		\subsection{Decomposition group and decomposition field}
			...
			\begin{corollary} 
				Let $A$ be an integrally closed ring. Let $E$ be a finite separable extension of $K$, and $B$ the integral closure of $A$ in $E$. Let $\mfk{p}$ be a maximal ideal of $A$. Then there exists only a finite number of prime ideals of $B$ lying above $\mfk{p}$.
			\end{corollary}
			\begin{proof}
				Let $L$ be the smallest Galois extension of $K$ containing $E$. If $\mfk{Q}_1$ and $\mfk{Q}_2$ are two distinct prime ideals of $B$ lying above $\mfk{p}$, and $\mfk{P}_1$, $\mfk{P}_2$ are two prime ideals of the integral closure of $A$ in $L$ lying above $\mfk{Q}_1$ and $\mfk{Q}_2$ respectively, then $\mfk{P}_1 \ne \mfk{P}_2$. This argument reduces our assertion to the case that $E$ is Galois over $K$, and it then becomes an immediate consequence of the proposition.
			\end{proof}
