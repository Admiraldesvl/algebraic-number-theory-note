\chapter{Algebraic Integers}
	...
	\section{Galois extensions}
		...
		\subsubsection{Decomposition group}
			...
			\begin{proof}
				...
				\]
				Then $\mfk{Q}_\sigma \ne \mfk{Q}$ (they are two distinct primes and are maximal because $B^d$ is Dedekind). Let $x$ be an element of $B^d$. By Chinese remainder theorem, there exists an element $y \in B^d$ such that
				\[
					\begin{aligned}
						y &\equiv x \mod \mfk{Q}, \\
